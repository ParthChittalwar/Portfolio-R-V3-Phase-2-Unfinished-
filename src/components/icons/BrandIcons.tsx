...
/**
 * Brand/logo icons for social links.
 *
 * lucide-react v1 removed brand icons (Github, Linkedin, Youtube, Twitter,
 * Instagram) entirely. Rather than depend on a second icon library just for
 * five logos, these are small inline SVGs matching lucide's 24x24
 * viewBox/`currentColor` convention so they drop into the same `IconComponent`
 * type used throughout `src/data/socials.ts`.
 */
...
export function YoutubeIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" {...props}>
      <path d="M23.498 6.186a2.974 2.974 0 0 0-2.093-2.093C19.692 3.5 12 3.5 12 3.5s-7.692 0-9.405.593A2.974 2.974 0 0 0 .502 6.186 31.27 31.27 0 0 0 0 12a31.27 31.27 0 0 0 .502 5.814 2.974 2.974 0 0 0 2.093 2.093C4.308 20.5 12 20.5 12 20.5s7.692 0 9.405-.593a2.974 2.974 0 0 0 2.093-2.093A31.27 31.27 0 0 0 24 12a31.27 31.27 0 0 0-.502-5.814zM9.75 15.568V8.432L15.818 12 9.75 15.568z" />
    </svg>
  );
}
...
export function TwitterXIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" {...props}>
      <path d="M18.244 2.25h3.308l-7.227 8.26 8.26 10.99h-6.466l-5.05-6.7-5.78 6.7H1.98l7.73-8.835L1.5 2.25h6.59l4.59 6.09 5.564-6.09zm-1.161 18.42h1.84L7.04 4.126H5.06z" />
    </svg>
  );
}
